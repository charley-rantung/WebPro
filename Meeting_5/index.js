...
//forEach dan map
//dalam forEach adalah fungsi yang dilakukan setiap elemennya
let aangka = [1,2,3,4,5,6,7,8];

aangka.forEach(function(el){
    console.log(el)
...
//sort
aangka.sort(function (a,b){
    return a - b;
})
console.log(aangka);

//filter
let aangka3 = aangka.filter(function(el){
    return el>5;
});